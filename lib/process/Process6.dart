...
class Process6Screen extends StatefulWidget {
  static const routeName = "/Process6Screen";
  const Process6Screen({Key? key}) : super(key: key);

  @override
  State<Process6Screen> createState() => _Process6ScreenState();
}

class _Process6ScreenState extends State<Process6Screen> {
          ...
          Column(
            children: [
              ...
              CustomButton('Yes', _width * 0.95, () {
                ...
                Navigator.pushNamed(context, Process7Screen.routeName);
              }),
              SizedBox(height: _width*0.01,),
